...
const updateProjectById = async (id: string): Promise<DatabaseProject> => {
...
const getProjectById = async (): Promise<DatabaseProject> => {
  const res = await api.get(`${PROJECT_API_URL}/getProjectById`);
  if (res.status !== 200) {
...
const updateCollaboratorRole = async (user: string, id: string): Promise<DatabaseProject> => {
...
const getFiles = async (projectId: string): Promise<DatabaseProject> => {
...
const createFile = async (projectId: string): Promise<DatabaseProjectFile> => {
...
const updateFileById = async (projectId: string, fileId: string): Promise<DatabaseProjectFile> => {
...
const deleteCommentById = async (
  ...
  const res = await api.delete(`${PROJECT_API_URL}/${id}/${fileId}/deleteCommentById/${comment}`);
  if (res.status !== 200) {
